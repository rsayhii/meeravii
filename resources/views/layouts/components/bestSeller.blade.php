...
@foreach ($product as $item)
    ...
    <div class="swiper-slide py-4">
        <a href="{{ url('product', $item->id) }}">
            <div class="bg-white rounded-2xl overflow-hidden shadow-sm relative group transition duration-300 hover:shadow-lg">
                <span class="absolute top-3 left-3 bg-yellow-100 text-gray-800 text-xs px-2 py-1 rounded z-20">
                    Sale
                </span>
                ...
                <div class="relative">
                    ...
                    <!-- Quick View -->
                    <div class="absolute bottom-3 left-0 right-0 flex justify-center opacity-0 group-hover:opacity-100 transition duration-300">
                        <button class="bg-[#3f5745] text-white text-xs sm:text-sm w-[180px] sm:w-[220px] py-2 rounded-2xl shadow-lg">
                            Quick view
                        </button>
                    </div>
                </div>
                ...
                <div class="p-3 sm:p-4">
                    <h3 class="text-gray-800 font-medium text-sm sm:text-base max-w-xs truncate">
                        {{ $item->name }}
                    </h3>
                    <div class="mt-2 flex items-center space-x-2">
                        ...
                        <span class="bg-gray-100 text-gray-700 text-[10px] sm:text-xs px-2 py-1 rounded">
                            -20%
                        </span>
                    </div>
                </div>
